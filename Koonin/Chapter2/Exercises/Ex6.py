"""
Exercise 6: Investigate the stability of several other integration methods discussed
in this chapter by applying them to the problem (2.28): 
        dy/dx = -y; y(x=0) = 1
Can you give analytical arguments to explain the results you obtain?
"""
import numpy as np
...
def main():
    ...
    while h > 0.0:
        ...
        times, soly = RK2(func, x0, xe, y0, h)
        print()
        print("Using Runge-Kutta Third order method:")
        times, sol1y = RK3(func, x0, xe, y0, h)
        print()
        print("Using Runge-Kutta Fourth order method:")
        times, sol2y = RK4(func, x0, xe, y0, h)
        if xe > 3.0:
